...
gan_trainer = SrganTrainer(generator=gan_generator, discriminator=discriminator_new())

# Train the GAN with 200,000 steps.
gan_trainer.train(train_ds, steps=200000)

# Save weights of generator and discriminator.
gan_trainer.generator.save_weights('weights/freq/gan_generator_1.h5')
gan_trainer.discriminator.save_weights('weights/freq/gan_discriminator_1.h5')
